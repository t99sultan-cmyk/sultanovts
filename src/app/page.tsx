...
export default function Home() {
  ...
  useEffect(() => {
    const observerOptions = { root: null, rootMargin: '300px 0px 0px 0px', threshold: 0 };
    ...
    <>
      ...
      <div ref={containerRef} className="w-full max-w-[430px] bg-white min-h-screen relative shadow-[0_0_80px_rgba(0,0,0,0.1)] overflow-clip pb-36 sm:border-x border-gray-200 mx-auto text-[15px] leading-relaxed selection:bg-orange-200 selection:text-gray-900" id="main-container">
          ...
          <div className="bg-white rounded-[2rem] overflow-hidden border border-gray-200 mb-8 shadow-sm reveal">
            ...
            <div className="p-6 relative">
              ...
              <p className="text-[14px] text-gray-700 leading-relaxed font-medium">
                Меня зовут Тимур, я основатель агентства Zeus. Мы не продаем «настройки в рекламном кабинете», мы управляем маркетинговым капиталом (до <strong className="text-orange-500 border-b border-orange-500/30">$31,270 в месяц</strong>) и отвечаем за <span className="text-orange-600 font-bold">окупаемость</span>. Вот мой опыт в сухих цифрах:
              </p>
            </div>
          </div>
        ...
        <main className="px-5 mt-6 relative z-10 pb-16">
          <div className="mb-10 reveal">
            <div className="bg-[#05050A] rounded-[2rem] p-8 shadow-[0_20px_50px_rgba(249,115,22,0.15)] relative overflow-hidden border border-orange-500/20">
              <AnimatedGridPattern 
                numSquares={30} 
                maxOpacity={0.15} 
                duration={3} 
          ...
          <div className="relative w-full z-20 pb-4">
            ...
            {/* Rule 1 - ORANGE */}
            <motion.div initial={{ opacity: 0, x: -70, scale: 0.95 }} whileInView={{ opacity: 1, x: 0, scale: 1 }} transition={{ duration: 0.7, type: "spring", bounce: 0.4 }} viewport={{ once: true, margin: "-100px" }} className="relative bg-white text-gray-900 rounded-[2.5rem] px-5 py-8 mb-6 border border-gray-200 shadow-[0_5px_20px_rgba(0,0,0,0.05)] overflow-hidden">
              ...
              <div className="space-y-4 text-gray-700 text-[15px] relative z-20">
                ...
                <div className="bg-gradient-to-br from-red-50 to-gray-50 p-6 rounded-2xl border border-red-100 shadow-[inset_0_2px_10px_rgba(239,68,68,0.05)] relative group bg-white">
                ...
                <div className="bg-orange-50/50 p-6 rounded-[2rem] border border-orange-200 shadow-sm mt-4">
                  ...
                  <div className="relative mt-2 mb-6 rounded-2xl overflow-hidden border border-orange-200/60 shadow-[0_10px_30px_rgba(249,115,22,0.1)] bg-white group hover:shadow-[0_15px_40px_rgba(249,115,22,0.15)] transition-shadow duration-300">
                    ...
                    <div className="w-full h-auto bg-gray-50 flex items-center justify-center relative overflow-hidden">
                      ...
                      <motion.img initial={{ opacity: 0, scale: 0.95 }} whileInView={{ opacity: 1, scale: 1 }} transition={{ duration: 0.5 }} viewport={{ once: true }} src="/crm.png" alt="Оцифровка студии" className="w-full h-auto object-contain filter contrast-[1.1] hover:scale-[1.03] transition-transform duration-700" />
                    </div>
                  ...
                  <div className="rounded-[2rem] p-6 my-5 border border-orange-200 shadow-inner group bg-white relative overflow-hidden">
                     <div className="flex items-center justify-between mb-6 relative z-10">
                       ...
                       <span className="text-[20px] animate-emoji">🏢</span>
                     </div>
            ...
            {/* Rule 2 - PURPLE */}
            <motion.div initial={{ opacity: 0, y: 70, scale: 0.95 }} whileInView={{ opacity: 1, y: 0, scale: 1 }} transition={{ duration: 0.7, type: "spring", bounce: 0.4 }} viewport={{ once: true, margin: "-100px" }} className="relative bg-[#FCFCFD] [background-image:radial-gradient(#e5e7eb_2px,transparent_2px)] [background-size:20px_20px] text-gray-900 rounded-[2.5rem] px-5 py-8 mb-6 border border-purple-200 shadow-[0_5px_20px_rgba(0,0,0,0.05)] z-[20] overflow-hidden">
              ...
              <div className="space-y-4 text-gray-700 text-[15px] relative z-20">
                ...
                <div className="relative w-full h-[380px] sm:h-[480px] rounded-[2rem] mt-8 mb-4 overflow-hidden border border-purple-200 shadow-sm group bg-gray-900">
                  <motion.img initial={{ opacity: 0, scale: 1.1 }} whileInView={{ opacity: 1, scale: 1 }} transition={{ duration: 0.7 }} viewport={{ once: true }} src="/process.jpg" alt="Управление лидами в AmoCRM" className="w-full h-full object-cover object-center transition-transform duration-700 opacity-95" />
                ...
                <div className="bg-purple-50/50 p-6 rounded-[2rem] border border-purple-200 shadow-sm mt-4">
                  ...
                  <div className="rounded-[2rem] p-6 my-5 border border-purple-200 shadow-inner group bg-white relative overflow-hidden">
                     ...
                     <div className="flex flex-col gap-4 relative z-10">
                       <div className="flex items-center gap-3">
                         <div className="w-10 h-10 rounded-xl bg-gray-100 flex items-center justify-center border border-gray-200 z-10 text-[16px] animate-emoji">🌍</div>
                       ...
                       <div className="flex items-center gap-3">
                         <div className="w-10 h-10 rounded-xl bg-purple-100 flex items-center justify-center border border-purple-200 z-10 text-[18px] animate-emoji" style={{ animationDelay: '0.2s' }}>🎟️</div>
                       ...
                       <div className="flex items-center gap-3">
                         <div className="w-10 h-10 rounded-xl bg-pink-100 flex items-center justify-center border border-pink-200 z-10 text-[18px] animate-emoji" style={{ animationDelay: '0.4s' }}>💰</div>
                  ...
                  <div className="bg-gradient-to-br from-purple-50 to-white p-6 rounded-[1.5rem] border-[1.5px] border-purple-300 shadow-[0_10px_30px_rgba(168,85,247,0.1)] mt-5 relative group overflow-hidden">
            ...
            {/* Rule 3 - BLUE */}
            <motion.div initial={{ opacity: 0, x: 70, scale: 0.95 }} whileInView={{ opacity: 1, x: 0, scale: 1 }} transition={{ duration: 0.7, type: "spring", bounce: 0.4 }} viewport={{ once: true, margin: "-100px" }} className="relative bg-[#F8FAFC] [background-image:radial-gradient(#cbd5e1_2px,transparent_2px)] [background-size:20px_20px] text-gray-900 rounded-[2.5rem] px-5 py-8 mb-6 border border-blue-200 shadow-[0_5px_20px_rgba(0,0,0,0.05)] z-[30] overflow-hidden">
              ...
              <div className="space-y-4 text-gray-700 text-[15px] relative z-20">
                ...
                <div className="relative w-full h-[380px] sm:h-[450px] rounded-[2rem] mt-6 overflow-hidden border border-blue-200 shadow-sm group bg-[#0A1128]">
                  <motion.img initial={{ opacity: 0, rotate: -2, scale: 1.05 }} whileInView={{ opacity: 1, rotate: 0, scale: 1 }} transition={{ duration: 0.7 }} viewport={{ once: true }} src="/office.jpg" alt="Закрытый разбор стратегии масштабирования" className="w-full h-full object-cover object-center transition-all duration-500 opacity-90" />
            ...
            {/* Rule 4 - EMERALD */}
            <motion.div initial={{ opacity: 0, y: -70, scale: 0.95 }} whileInView={{ opacity: 1, y: 0, scale: 1 }} transition={{ duration: 0.7, type: "spring", bounce: 0.4 }} viewport={{ once: true, margin: "-100px" }} className="relative bg-[#F4FDF8] [background-image:radial-gradient(#a7f3d0_2px,transparent_2px)] [background-size:20px_20px] text-gray-900 rounded-[2.5rem] px-5 py-8 mb-6 border border-emerald-200 shadow-[0_5px_20px_rgba(0,0,0,0.05)] z-[40] overflow-hidden">
                ...
                <div className="bg-emerald-50/50 p-6 rounded-[2rem] border border-emerald-200 shadow-sm mt-5">
                  ...
                  <div className="relative w-full max-w-[320px] mx-auto mt-8 mb-6 transform -rotate-1 hover:rotate-0 transition-transform duration-300">
                    ...
                    <div className="bg-white p-2 rounded-2xl shadow-[0_15px_35px_rgba(0,0,0,0.1)] border border-gray-100 relative z-10 overflow-hidden">
                      ...
                      <motion.img initial={{ opacity: 0, rotate: -15, scale: 0.8 }} whileInView={{ opacity: 1, rotate: 0, scale: 1 }} transition={{ duration: 0.6 }} viewport={{ once: true }} src="/review.jpg" alt="Отзыв клиента Prostretching" className="w-full h-auto rounded-xl object-contain relative z-10" />
                    </div>
                  </div>
        ...
        <section className="reveal relative mb-12 pt-6">
          <div className="inline-flex items-center space-x-2 bg-gradient-to-r from-gray-900 to-gray-800 text-white border border-gray-700 rounded-full px-4 py-2 mb-6 shadow-xl w-max ml-auto mr-auto flex">
            <div className="w-2 h-2 rounded-full bg-emerald-500 animate-pulse"></div>
            <span className="text-[11px] font-black tracking-widest uppercase">Факты и цифры</span>
          </div>
          <h3 className="text-[28px] font-black text-center text-gray-900 mb-4 tracking-tight leading-tight max-w-sm mx-auto mt-2 drop-shadow-sm">
            Бизнес <span className="text-red-800 underline decoration-red-300 decoration-4 underline-offset-4">доверяет</span> мне чеки от 500k до 2 млн ₸
          </h3>
          <p className="text-black text-[15px] font-bold text-center mb-8 max-w-sm mx-auto px-4 leading-relaxed">Это не просто скриншоты! За каждым чеком стоит системная прибыль, которую сгенерировала наша команда.</p>

          <div className="flex overflow-x-auto gap-4 px-5 items-center w-full py-6 snap-x hide-scrollbar">
            
            {/* INVOICE 1: 1.95M */}
            <div className="w-[300px] shrink-0 snap-center bg-[#0A0D14] rounded-[2rem] border border-white/10 overflow-hidden flex flex-col relative shadow-[0_20px_40px_rgba(0,0,0,0.8)] transition-all duration-300 group hover:-translate-y-2 hover:shadow-[0_30px_60px_rgba(249,115,22,0.2)] transform-gpu hover:z-50" style={{ transform: 'translateZ(0)' }}>
                {/* Premium "Paid" Badge */}
                ...
                <div className="w-full h-36 bg-[#F5F5F7] flex items-center justify-center overflow-hidden p-3 mix-blend-screen relative">
                  ...
                  <img src="/kaspi-2.jpg" alt="Счет 1 950 000 ₸" className="w-full h-full object-contain filter grayscale contrast-125 object-center mix-blend-multiply transition-transform duration-700 group-hover:scale-110" />
                </div>
                ...
                <div className="p-6 flex flex-col border-t border-white/5 bg-gradient-to-b from-[#0A0D14] to-black relative z-20">
                  ...
                  <div className="text-[15px] sm:text-[16px] font-bold text-gray-200 mb-3 leading-tight">Медицинский центр</div>
                  <div className="text-orange-500 font-numbers font-black text-[28px] sm:text-[32px] drop-shadow-[0_0_15px_rgba(249,115,22,0.4)] leading-none tracking-tight">1 950 000 ₸</div>
                </div>
            </div>
            ...
            <div className="w-[300px] shrink-0 snap-center bg-[#0A0D14] rounded-[2rem] border border-white/10 overflow-hidden flex flex-col relative shadow-[0_20px_40px_rgba(0,0,0,0.8)] transition-all duration-300 group hover:-translate-y-2 hover:shadow-[0_30px_60px_rgba(249,115,22,0.2)] transform-gpu hover:z-50" style={{ transform: 'translateZ(0)' }}>
                ...
                <div className="w-full h-36 bg-[#F5F5F7] flex items-center justify-center overflow-hidden p-3 mix-blend-screen relative">
                  <div className="absolute inset-0 bg-gradient-to-t from-[#0A0D14] to-transparent opacity-60 z-10 pointer-events-none transition-opacity duration-300 group-hover:opacity-20"></div>
                  <img src="/kaspi-5.jpg" alt="Счет 830 000 ₸" className="w-full h-full object-contain filter grayscale contrast-125 object-center mix-blend-multiply transition-transform duration-700 group-hover:scale-110" />
                </div>
                
                <div className="p-6 flex flex-col border-t border-white/5 bg-gradient-to-b from-[#0A0D14] to-black relative z-20">
                  <span className="text-[11px] font-bold text-gray-500 uppercase tracking-widest mb-1.5">Доверил:</span>
                  <div className="text-[15px] sm:text-[16px] font-bold text-gray-200 mb-3 leading-tight">Центр косметологии</div>
                  <div className="text-orange-500 font-numbers font-black text-[28px] sm:text-[32px] drop-shadow-[0_0_15px_rgba(249,115,22,0.4)] leading-none tracking-tight">830 000 ₸</div>
                </div>
            </div>
            ...
            <div className="w-[300px] shrink-0 snap-center bg-[#0A0D14] rounded-[2rem] border border-white/10 overflow-hidden flex flex-col relative shadow-[0_20px_40px_rgba(0,0,0,0.8)] transition-all duration-300 group hover:-translate-y-2 hover:shadow-[0_30px_60px_rgba(249,115,22,0.2)] transform-gpu hover:z-50" style={{ transform: 'translateZ(0)' }}>
                ...
                <div className="w-full h-36 bg-[#F5F5F7] flex items-center justify-center overflow-hidden p-3 mix-blend-screen relative">
                  <div className="absolute inset-0 bg-gradient-to-t from-[#0A0D14] to-transparent opacity-60 z-10 pointer-events-none transition-opacity duration-300 group-hover:opacity-20"></div>
                  <img src="/kaspi-4.jpg" alt="Счет 592 665 ₸" className="w-full h-full object-contain filter grayscale contrast-125 object-center mix-blend-multiply transition-transform duration-700 group-hover:scale-110" />
                </div>
                
                <div className="p-6 flex flex-col border-t border-white/5 bg-gradient-to-b from-[#0A0D14] to-black relative z-20">
                  <span className="text-[11px] font-bold text-gray-500 uppercase tracking-widest mb-1.5">Доверил:</span>
                  <div className="text-[15px] sm:text-[16px] font-bold text-gray-200 mb-3 leading-tight">Стоматология</div>
                  <div className="text-orange-500 font-numbers font-black text-[28px] sm:text-[32px] drop-shadow-[0_0_15px_rgba(249,115,22,0.4)] leading-none tracking-tight">592 665 ₸</div>
                </div>
            </div>
            ...
            <div className="w-[300px] shrink-0 snap-center bg-[#0A0D14] rounded-[2rem] border border-white/10 overflow-hidden flex flex-col relative shadow-[0_20px_40px_rgba(0,0,0,0.8)] transition-all duration-300 group hover:-translate-y-2 hover:shadow-[0_30px_60px_rgba(249,115,22,0.2)] transform-gpu hover:z-50" style={{ transform: 'translateZ(0)' }}>
                ...
                <div className="w-full h-36 bg-[#F5F5F7] flex items-center justify-center overflow-hidden p-3 mix-blend-screen relative">
                  <div className="absolute inset-0 bg-gradient-to-t from-[#0A0D14] to-transparent opacity-60 z-10 pointer-events-none transition-opacity duration-300 group-hover:opacity-20"></div>
                  <img src="/kaspi-1.jpg" alt="Счет 500 000 ₸" className="w-full h-full object-contain filter grayscale contrast-125 object-center mix-blend-multiply transition-transform duration-700 group-hover:scale-110" />
                </div>
                
                <div className="p-6 flex flex-col border-t border-white/5 bg-gradient-to-b from-[#0A0D14] to-black relative z-20">
                  <span className="text-[11px] font-bold text-gray-500 uppercase tracking-widest mb-1.5">Доверил:</span>
                  <div className="text-[15px] sm:text-[16px] font-bold text-gray-200 mb-3 leading-tight">Expert Neuro</div>
                  <div className="text-orange-500 font-numbers font-black text-[28px] sm:text-[32px] drop-shadow-[0_0_15px_rgba(249,115,22,0.4)] leading-none tracking-tight">500 000 ₸</div>
                </div>
            </div>
            ...
            <div className="w-[300px] shrink-0 snap-center bg-[#0A0D14] rounded-[2rem] border border-white/10 overflow-hidden flex flex-col relative shadow-[0_20px_40px_rgba(0,0,0,0.8)] transition-all duration-300 group hover:-translate-y-2 hover:shadow-[0_30px_60px_rgba(249,115,22,0.2)] transform-gpu hover:z-50" style={{ transform: 'translateZ(0)' }}>
                ...
                <div className="w-full h-36 bg-[#F5F5F7] flex items-center justify-center overflow-hidden p-3 mix-blend-screen relative">
                  <div className="absolute inset-0 bg-gradient-to-t from-[#0A0D14] to-transparent opacity-60 z-10 pointer-events-none transition-opacity duration-300 group-hover:opacity-20"></div>
                  <img src="/kaspi-3.jpg" alt="Счет 430 000 ₸" className="w-full h-full object-contain filter grayscale contrast-125 object-center mix-blend-multiply transition-transform duration-700 group-hover:scale-110" />
                </div>
                
                <div className="p-6 flex flex-col border-t border-white/5 bg-gradient-to-b from-[#0A0D14] to-black relative z-20">
                  <span className="text-[11px] font-bold text-gray-500 uppercase tracking-widest mb-1.5">Доверил:</span>
                  <div className="text-[15px] sm:text-[16px] font-bold text-gray-200 mb-3 leading-tight">Многопрофильная клиника</div>
                  <div className="text-orange-500 font-numbers font-black text-[28px] sm:text-[32px] drop-shadow-[0_0_15px_rgba(249,115,22,0.4)] leading-none tracking-tight">430 000 ₸</div>
                </div>
            </div>
            ...
            <div className="w-[300px] shrink-0 snap-center bg-[#0A0D14] rounded-[2rem] border border-white/10 overflow-hidden flex flex-col relative shadow-[0_20px_40px_rgba(0,0,0,0.8)] transition-all duration-300 group hover:-translate-y-2 hover:shadow-[0_30px_60px_rgba(249,115,22,0.2)] transform-gpu hover:z-50" style={{ transform: 'translateZ(0)' }}>
                ...
                <div className="w-full h-36 bg-[#F5F5F7] flex items-center justify-center overflow-hidden p-3 mix-blend-screen relative">
                  <div className="absolute inset-0 bg-gradient-to-t from-[#0A0D14] to-transparent opacity-60 z-10 pointer-events-none transition-opacity duration-300 group-hover:opacity-20"></div>
                  <img src="/kaspi-6.jpg" alt="Счет 500 000 ₸" className="w-full h-full object-contain filter grayscale contrast-125 object-center mix-blend-multiply transition-transform duration-700 group-hover:scale-110" />
                </div>
                
                <div className="p-6 flex flex-col border-t border-white/5 bg-gradient-to-b from-[#0A0D14] to-black relative z-20">
                  <span className="text-[11px] font-bold text-gray-500 uppercase tracking-widest mb-1.5">Доверил:</span>
                  <div className="text-[15px] sm:text-[16px] font-bold text-gray-200 mb-3 leading-tight">Лидогенерация</div>
                  <div className="text-orange-500 font-numbers font-black text-[28px] sm:text-[32px] drop-shadow-[0_0_15px_rgba(249,115,22,0.4)] leading-none tracking-tight">500 000 ₸</div>
                </div>
            </div>
        ...
        <section className="reveal px-5 pt-12 pb-16 relative z-10 overflow-hidden border-t-2 border-gray-100 rounded-t-[3rem] mt-4">
          ...
          {/* STATIC PREMIUM DARK NOISE BACKGROUND */}
          ...
          <p className="text-gray-400 mt-8 leading-relaxed text-[16px] text-center px-2">
            Я строил эти системы для брендов с мировым именем и локальных лидеров рынка с бюджетами до <strong className="text-white">$31 270 в месяц</strong>. Мой опыт — это десятки миллионов тенге, превращенных в чистую прибыль моих клиентов.
          </p>

          <div className="mt-12 w-full relative">
            <h4 className="text-[22px] sm:text-[26px] font-black mb-6 text-center text-orange-500 px-5 drop-shadow-[0_0_15px_rgba(249,115,22,0.4)] tracking-tight">Компании, доверившие мне свою архитектуру роста:</h4>            
            ...
            <div className="overflow-x-auto pb-10 pt-2 snap-x hide-scrollbar px-5">
               <div className="grid grid-rows-3 grid-flow-col gap-4 w-max">
                 {logos.map((logo, index) => (
                   <div 
                     key={`${logo}-${index}`} 
                     className="relative bg-white shrink-0 snap-center rounded-[1.5rem] w-[180px] h-[90px] sm:w-[220px] sm:h-[110px] flex flex-col items-center justify-center p-4 border border-gray-100 shadow-[0_15px_25px_rgba(0,0,0,0.08)] transition-all duration-300 hover:scale-[1.05] group cursor-pointer"
                   >
        ...
        <div className="bg-[#05050A] text-white rounded-t-[3rem] pb-16 pt-12 relative shadow-[0_-20px_50px_rgba(0,0,0,0.5)] border-t border-white/10 z-20 overflow-hidden" id="offer-section">
          ...
          <div className="px-5 relative z-10">
            <div className="reveal text-center">
              ...
              <div className="relative mb-10 p-6 sm:p-8 rounded-[2rem] border-2 border-orange-500/50 bg-[#1A0A05] shadow-[0_0_50px_rgba(249,115,22,0.15)] overflow-hidden group">
                ...
                <h2 className="text-[24px] sm:text-[30px] font-black leading-tight tracking-tight text-white text-left relative z-10">
                  ...
                  <span className="text-white drop-shadow-[0_0_20px_rgba(249,115,22,1)] font-black animate-pulse text-[40px] sm:text-[50px] border-b-[5px] border-orange-500 inline-block mt-2 mb-3 bg-gradient-to-r from-orange-600/30 to-red-600/30 px-4 md:px-7 py-2 rounded-[1rem] shadow-[inset_0_0_20px_rgba(249,115,22,0.3)] backdrop-blur-sm">300 000 000 ₸ в год</span><br className="hidden sm:block"/>
            ...
            <div className="bg-[#0F0F1A] rounded-[2.5rem] p-8 mb-10 reveal relative overflow-hidden shadow-[0_20px_50px_rgba(0,0,0,0.5)] border border-white/5">
              ...
              <div className="bg-[#0F0A08] border border-orange-500/30 rounded-[2rem] p-6 sm:p-8 mb-8 relative z-10 shadow-[0_15px_40px_rgba(249,115,22,0.1)] overflow-hidden group">
                <div className="absolute -top-10 -left-10 w-32 h-32 bg-orange-500/10 rounded-full blur-[40px]"></div>
                
                <div className="flex flex-col sm:flex-row items-center justify-between gap-6 relative z-10 mb-8 border-b border-white/5 pb-8">
                  <div className="flex-1 text-center sm:text-left">
                     <p className="text-gray-500 text-[14px] mb-2 font-medium line-through">Рыночная стоимость аудита — 150 000 ₸.</p>
                     <p className="text-[16px] font-bold text-white">Доступ к системе за символический депозит:</p>
                  </div>
                  <div className="shrink-0 relative overflow-hidden bg-gradient-to-br from-orange-500 to-red-600 px-8 sm:px-10 py-5 rounded-[2.5rem] shadow-[0_15px_40px_rgba(249,115,22,0.5)] group-hover:scale-110 transition-transform duration-500 border-2 border-white/20">
                    <div className="absolute inset-0 bg-[url('/noise.png')] opacity-30 mix-blend-overlay pointer-events-none"></div>
                    <div className="absolute -top-10 -right-10 w-24 h-24 bg-white/40 rounded-full blur-[25px] pointer-events-none"></div>
                    <div className="absolute -bottom-10 -left-10 w-24 h-24 bg-red-900/50 rounded-full blur-[20px] pointer-events-none"></div>
                    <div className="text-[48px] sm:text-[60px] font-numbers font-black text-white leading-none tracking-tight drop-shadow-[0_4px_10px_rgba(0,0,0,0.4)] relative z-10 flex items-center justify-center gap-3">
                       990 <span className="text-[20px] sm:text-[24px] text-white/90 font-bold uppercase tracking-widest pb-1 self-end mb-2">kzt</span>
                    </div>
                  </div>
                </div>

                <div className="grid grid-cols-1 sm:grid-cols-2 gap-6 relative z-10">
                  <div className="bg-white/5 p-5 rounded-[1.2rem] border border-white/5">
                     <div className="text-orange-500 font-black mb-2 text-[16px]">Почему так дешево?</div>
                     <p className="text-gray-300 text-[13px] leading-relaxed font-medium">Здесь нет подвоха. Моя задача оценить вашу архитектуру. На выходе вы получаете детальный план масштабирования. Дальше вы внедряете его сами, либо мы договариваемся о партнерстве.</p>
                  </div>
                  <div className="bg-white/5 p-5 rounded-[1.2rem] border border-white/5">
                     <div className="text-orange-500 font-black mb-2 text-[16px]">Жесткий фильтр</div>
                     <p className="text-gray-300 text-[13px] leading-relaxed font-medium">Я убил "бесплатные вебинары". Эта сумма — фильтр адекватности, который отсекает случайных зрителей и экономит мое время на тех, кому реально нужен рост.</p>
                  </div>
                </div>
              </div>
            </div>
            ...
            <div className="mb-14 reveal">
              ...
              <div className="grid gap-4">
                <div className="bg-gradient-to-br from-[#0F0F1A] to-[#141423] shadow-lg border border-blue-500/20 rounded-[2rem] p-6 flex flex-col sm:flex-row items-center sm:items-start gap-5 transition-transform hover:-translate-y-1 text-center sm:text-left hover:border-blue-500/50 group">
                ...
                <div className="bg-gradient-to-br from-[#0F0F1A] to-[#1A121F] shadow-lg border border-purple-500/20 rounded-[2rem] p-6 flex flex-col sm:flex-row items-center sm:items-start gap-5 transition-transform hover:-translate-y-1 text-center sm:text-left hover:border-purple-500/50 group">
                ...
                <div className="bg-gradient-to-br from-[#0F0F1A] to-[#0F1A15] shadow-lg border border-emerald-500/20 rounded-[2rem] p-6 flex flex-col sm:flex-row items-center sm:items-start gap-5 transition-transform hover:-translate-y-1 text-center sm:text-left hover:border-emerald-500/50 group">
              ...
              <div className="bg-gradient-to-b from-[#110505] to-[#0a0202] p-6 sm:p-8 rounded-[2.5rem] shadow-[0_15px_40px_rgba(220,38,38,0.15)] relative overflow-hidden group hover:border-red-600/50 transition-colors duration-500">
                ...
                <ul className="space-y-4 relative z-10">
                  <li className="flex items-start gap-4 p-5 bg-[#1A0A0A]/80 backdrop-blur-sm rounded-2xl border border-red-900/30 hover:bg-[#220c0c] transition-all duration-300 hover:translate-x-2">
                    ...
                    <p className="text-[14px] text-gray-300 leading-relaxed font-medium"><strong className="text-white">Ищете "волшебную таблетку".</strong> Вы надеетесь, что можно закинуть 50$ в таргет и завтра получить миллионную прибыль, не меняя свой продукт.</p>
                  </li>
                  <li className="flex items-start gap-4 p-5 bg-[#1A0A0A]/80 backdrop-blur-sm rounded-2xl border border-red-900/30 hover:bg-[#220c0c] transition-all duration-300 hover:translate-x-2 delay-75">
                    <div className="text-red-500 font-bold text-[20px] leading-none shrink-0 mt-0.5 drop-shadow-[0_0_8px_rgba(239,68,68,0.5)]">✕</div>
                    <p className="text-[14px] text-gray-300 leading-relaxed font-medium"><strong className="text-white">У вас нет отдела продаж.</strong> Ваши лиды висят сутками, трубку никто не берет, и вы наивно считаете, что "хороший маркетолог должен сам всё продавать".</p>
                  </li>
                  <li className="flex items-start gap-4 p-5 bg-[#1A0A0A]/80 backdrop-blur-sm rounded-2xl border border-red-900/30 hover:bg-[#220c0c] transition-all duration-300 hover:translate-x-2 delay-150">
                    <div className="text-red-500 font-bold text-[20px] leading-none shrink-0 mt-0.5 drop-shadow-[0_0_8px_rgba(239,68,68,0.5)]">✕</div>
                    <p className="text-[14px] text-gray-300 leading-relaxed font-medium"><strong className="text-white">Вам не нужен рост.</strong> Вы боитесь системного подхода, не готовы вкладывать бюджет в трафик и не способны обрабатывать по 30-50 заявок ежедневно.</p>
                  </li>
                </ul>
            ...
            <div className="mt-8 reveal relative mb-8">
              ...
              <div className="bg-gradient-to-b from-[#050B06] to-[#020502] rounded-[3rem] p-8 mt-8 text-center relative overflow-hidden shadow-[0_20px_50px_rgba(22,163,74,0.15)] border border-green-500/40 group">
                ...
                <div className="flex flex-col items-center mb-8 relative z-10">
                  <div className="absolute -top-10 -right-10 text-[120px] opacity-[0.03] select-none pointer-events-none font-black text-green-500 rotate-12">ГАРАНТИЯ</div>
